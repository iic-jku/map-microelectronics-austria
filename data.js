...
window.COMPANIES = [
  ...
  { name: "ams OSRAM (sensor & foundry fab)", city: "Premstätten", state: "Styria", lat: 46.9768, lon: 15.3963, category: "semiconductor", web: "https://ams-osram.com" },
  ...
  { name: "Infineon Technologies Linz (design center, formerly DICE)", city: "Linz", state: "Upper Austria", lat: 48.3267, lon: 14.3232, category: "design", web: "https://www.infineon.com/austria" },
  ...
  { name: "Lam Research Salzburg (formerly Semsysco, wet chemistry / panel-level packaging)", city: "Salzburg", state: "Salzburg", lat: 47.7945, lon: 13.0121, category: "equipment", web: "https://www.lamresearch.com" },
  ...
  { name: "RHP-Technology (sputter targets, PV material recycling)", city: "Seibersdorf", state: "Lower Austria", lat: 47.9747, lon: 16.5078, category: "material", web: "https://rhp.at" },
